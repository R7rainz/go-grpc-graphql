...
// GetProducts covers three cases: list (skip/take), fetch by ids, and search
// (query). Whichever field is set decides which one the server runs.
...
func (x *GetProductsRequest) GetSkip() int32 {
	if x != nil {
		return x.Skip
	}
	return 0
...
func (x *GetProductsRequest) GetTake() int32 {
	if x != nil {
		return x.Take
	}
	return 0
...
const file_catalog_pb_catalog_proto_rawDesc = "" +
	"\n" +
	"\x18catalog/pb/catalog.proto\x12\n" +
	"catalog.v1\"e\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\x04take\x18\x02 \x01(\x05R\x04take\x12\x10\n" +
	"\x03ids\x18\x03 \x03(\tR\x03ids\x12\x14\n" +
	"\x05query\x18\x04 \x01(\tR\x05query\"F\n" +
	"\x13GetProductsResponse\x12/\n" +
	"\bproducts\x18\x01 \x03(\v2\x13.catalog.v1.ProductR\bproducts2\xfd\x01\n" +
	"\x0eCatalogService\x12N\n" +
	"\vPostProduct\x12\x1e.catalog.v1.PostProductRequest\x1a\x1f.catalog.v1.PostProductResponse\x12K\n" +
	"\n" +
	"GetProduct\x12\x1d.catalog.v1.GetProductRequest\x1a\x1e.catalog.v1.GetProductResponse\x12N\n" +
	"\vGetProducts\x12\x1e.catalog.v1.GetProductsRequest\x1a\x1f.catalog.v1.GetProductsResponseB2Z0github.com/r7rainz/go-grpc-graphql/catalog/pb;pbb\x06proto3"
