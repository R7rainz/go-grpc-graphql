...
type Repository interface {
	...
	ListAccounts(ctx context.Context, skip int, take int) ([]Account, error)
}

type Respository = Repository
...
func (r *postgresRepository) ListAccounts(ctx context.Context, skip int, take int) ([]Account, error) {
